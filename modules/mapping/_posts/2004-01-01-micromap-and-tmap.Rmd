...
The latest release of micromap can plot a `r class(shp)` object directly (there are plans to further develop the package to work with `sf` objects).  There are few required pieces of information:
